...
It **bridges** the visual world to spoken awareness — transforming what the camera sees into real-time guidance about class, direction, and **estimated distance** — with priority gating and haptics.
...
<div align="center">
  Built with ❤️ for Independence Hackathon.
</div>
